...
export function Sidebar() {
  ...
  return (
    <aside
      className={`h-screen bg-codex-sidebar border-codex-border flex flex-col select-none shrink-0 transition-all duration-300 relative group/sidebar ${
    ...
    >
      ...
      >
        ...
        <div className="px-2 py-2 space-y-0.5">
          <button
            onClick={() => {}}
            className="w-full flex items-center justify-between px-2 py-1.5 rounded-codex-md text-sm text-codex-muted hover:bg-codex-surface/80 hover:text-codex-foreground transition-colors group"
          >
          ...
          <button
            ...
            className="w-full flex items-center gap-2 px-2 py-1.5 rounded-codex-md text-sm text-codex-muted hover:bg-codex-surface/80 hover:text-codex-foreground transition-colors"
          >
        ...
        <div className="px-2 py-2 border-t border-codex-border/30">
          <button
            ...
            disabled={!activeWorkspace}
            className="w-full flex items-center gap-2 px-2 py-1.5 rounded-codex-md text-sm text-codex-muted hover:bg-codex-surface/80 hover:text-codex-foreground transition-colors disabled:opacity-50"
          >
      ...
      {isSidebarOpen && (
        <button
          ...
          className="absolute -right-3.5 top-8 z-50 p-1 bg-codex-surface border border-codex-border rounded-full text-codex-muted hover:text-codex-foreground hover:bg-codex-background opacity-0 group-hover/sidebar:opacity-100 transition-all shadow-sm flex items-center justify-center"
          title="Close sidebar"
        >
