...
export default function WorkspaceError({
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center animate-in fade-in zoom-in-95 duration-200">
      <div className="w-16 h-16 rounded-codex-xl bg-red-500/10 flex items-center justify-center text-red-500 mb-6">
      ...
      <button
        onClick={() => reset()}
        className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-white bg-codex-accent rounded-codex-xl hover:opacity-90 transition-opacity"
      >
